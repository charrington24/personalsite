...
var ImageLoader = function (_React$Component) {
  ...
  createClass(ImageLoader, [{
    ...
    value: function render() {
       ...
       */
      return lazyLoad ? React.createElement(
        VisibilitySensor,
        {
  ...
  return React.createElement(
    ...
    function (_ref2) {
      ...
      if (useChild) {
        ...
        childElement = React.cloneElement(children, { style: style });
      } else {
        /*
        ...
        hasLoaded ? style = _extends({}, style, backgroundImageStyle) : style;
        childElement = React.createElement(element, _extends({}, props, { style: style }), children);
      }
      ...
      return React.createElement(
        ...
        childElement,
        shouldShowLoader && !disableLoader && React.createElement(
          Fragment,
          null,
          renderLoader ? renderLoader({ hasLoaded: hasLoaded, hasFailed: hasFailed }) : React.createElement(Loader, {
            isOnTop: true,
            hasLoaded: hasLoaded,
            transitionTime: transitionTime
          })
  ...
  return (
    ...
    isResponsive ? React.createElement(BackgroundImage, _extends({
      ...
      function (_ref2) {
        ...
        return React.createElement(
          Wrapper$1,
          { width: width, height: height, className: wrapperClassName, ref: wrapperRef },
          hasLoaded && React.createElement(Img, _extends({ src: src, transitionTime: transitionTime }, props)),
          shouldShowLoader && !disableLoader && React.createElement(
            Fragment,
            null,
            renderLoader ? renderLoader({ hasLoaded: hasLoaded, hasFailed: hasFailed }) : React.createElement(Loader, null)
          )
        );
      }
    )
